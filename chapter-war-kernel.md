...
> 언어, 정보, 생명을 한꺼번에 묶을 수 있으면 반주권 설계(사람을 가두지 않는 설계)는 반쪽짜리다.

## 16.1 왜 이 장이 필요한가

반주권 설계 v4는 다섯 사례에서 락인(갇힘) 판별식(갇힘 확인표)을 검증했다 — 지역, 비지역,
물리적, 관계적, 인정 체계(인정 시장) 주권. 그러나 다섯 사례 모두 **평시**를 전제한다.
...
이건 기존 5사례의 "합작 락인(짝꿍 갇힘)"과는 다른 차원의 락인이다. 합작 락인이
...
| 동원·징병 | 본인 선택 | 강제 징집, 예비군 소집, 양심적 거부권 제한 또는 부재 | 돌봄 (관계적 락인(관계 갇힘))의 강제 버전 |
...
**락인 위험도(갇힘 위험도): 매우 높음 (4/4 항 만족, 전부 "매우 높음")**
...
2. **교차점에서 창발(교차점에서 생김)하는 락인** — 각 주체가 자기 역할만 하는데, 교차점에서 국민의 모든 권리가 정지됨
