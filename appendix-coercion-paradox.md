...
바꿀 이유가 없다. 이주노동자의 탈출권을 강제하려면, 국가가 "고용주의
동의 없이 이직을 허용한다"고 법을 바꿔야 한다. 그런데 그 법을 바꾸는
주체가 바로 비자 제도를 운영하는 국가다.

처방을 채택할 권한을 가진 주체가, 처방에 의해 자신의 통제력을 줄여야 한다.

### 플랫폼: 데이터 이동성을 강제하는 주체가 새 독점자가 된다
...
"대체 생존조건 동반 원칙"을 강제하려면, 그 원칙을 집행하는 주체가 필요하고,
...
둘째, 역설이 드러나는 지점을 만든다. 락인 열지도, 측정권 공개,
...
넷째, 역설에 대응하는 속도를 다르게 한다. 빠른 장치(긴급 집행정지)는
