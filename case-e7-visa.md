...
권한이 줄어드는 구조**다. 이건 프레임워크 자체가 지적하는 "강제의 역설"이다.
...
```
비자 유형    | 이탈가능성 | 규칙강제성 | 항의실효성 | 의존비대칭 | 위험도
-----------|----------|----------|----------|----------|------
...
- 거주(F-2)와 재외동포(F-4)는 락인 위험도가 낮음 — 탈출권이 보장되는 구조의 참고점
...
**비지역적 주권**을 다루며, 같은 판별식이 영토 없는 주권자(Google/Apple/Meta)에도
적용됨을 보일 것이다.
