# 사례 연구: 학력 인증 독점 — 인정 체계(인정 시장) 락인(갇힘)

> 반주권 설계(사람을 가두지 않는 설계) v4 프레임워크의 다섯 번째이자 마지막 적용 사례.
> E-7이 "지역 주권"을, 플랫폼이 "비지역 주권"을, 의료가 "물리 인프라"를,
> 돌봄이 "관계적 락인(관계 갇힘)"을 다뤘다면, 이 사례는 **인정 체계 락인**을 다룬다.
...
### 락인 위험도(갇힘 위험도): 매우 높음 (학생), 높음 (부모·교사)
...
| 입시 트랙별 락인 열지도(갇힘 지도) | 커널(측정) | 트랙 변경 시 누적 손실, 전학율, 학점 인정률 공개 | 락인 열지도 |
