...
서로 달라 보이는 권력 구조를 같은 락인 판별식로 비교한다.
...
| [framework.md](./framework.md) | 706 | v4 프레임워크 전체 — 명제, 락인 판별식, 점수화, 방어 장치, 실험 엔진, AI 역할 |
...
관계, 인정 시장에 같은 락인 판별식가 적용되며, 합작 락인 구조가 다섯 영역에서
동일하게 나타난다.
...
1. **락인 판별식가 다섯 가지 힘 유형에 모두 적용** — 지역, 땅 없는 힘, 물리적, 관계, 인정 시장
