# 17. 국가 커널 락인 (National Kernel Lock-in)

> 국가법은 지역 합의 위에 놓인 최상위 강제 커널이다.
> 반주권 설계가 지역과 플랫폼만 분석하고 국가 입법·전쟁·비상권을
> 분석하지 않으면, 가장 큰 락인을 놓친다.

## 17.1 왜 이 장이 필요한가

전쟁권 장(16장)은 전쟁 버튼이 눌리면 모든 탈출권이 정지된다고 말했다.
...
커널은 그 강제가 국경·징병·계엄·동원으로 증폭되는 순간을 설명한다. 전쟁권
...
| 조항 | 원문 (검증됨) | 구조적 의미 |
| --- | --- | --- |
| 제40조 | "입법권은 국회에 속한다." | 모든 법률이 국회를 통과한다. 지역이 만드는 것은 법률이 아니라 조례다. |
...
| 제117조 ① | 지방자치단체는 주민의 복리에 관한 사무를 처리하고 재산을 관리하며, **법령의 범위 안에서** 자치에 관한 규정을 제정할 수 있다. | 지방자치는 국가 법령의 하위 설정이다. "법령의 범위"가 병목이다. |
...
압축 논리. 근데 실제로는 개별 법률, 전쟁, 징병, 지역 강제에 대해 국민이
직접 동의한 적은 없다.
...
16장이 다룬 전쟁권 락인은 이 블랙홀의 최고강도 예외 모드다. 그러나 평시에도
...
3. 처방은 입법·예산·인허가를 동시에 풀어야 — 한쪽만 풀면 반쯤 풀린 락인
...
| 3 | 조세·예산 강제 | 중간~높음 | 국회 과반 | 국회 과반 + 지역 재정 영향평가 공개 |
...
- 국가가 유예 승인권을 가지면, 그 권한이 새 통치 도구가 됨 (강제의 역설)
...
이건 프레임워크의 "포획 속도 저감"(명제 6)과 직결된다. 권한이 자동
