...
> 반주권 설계(사람을 가두지 않는 설계) v4 프레임워크의 두 번째 적용 사례.
> E-7이 "국가+고용주 합작 락인(짝꿍 갇힘)"을 보여줬다면,
...
이 사례가 프레임워크에 중요한 이유: 락인(갇힘) 판별식(갇힘 확인표)이 지역 경계에 묶이지
...
이건 프레임워크의 락인 위험도(갇힘 위험도) 점수가 왜 이항 판정이 아닌지를 보여주는
구체적 증거다.
...
| 플랫폼별 락인 열지도(갇힘 지도) 공개 | 정지율, 항소 성공률, 평균 복구 시간 공개 | 측정권 헌법화 |
