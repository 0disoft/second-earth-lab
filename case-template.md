...
> 반주권 설계(사람을 가두지 않는 설계) v4 프레임워크에 새 사례를 적용할 때 사용하는 템플릿.
...
> 다섯 사례가 검증한 다섯 주권 유형(지역, 비지역, 물리적, 관계적, 인정 체계(인정 시장))
...
### 락인 위험도(갇힘 위험도): [높음/매우 높음/중간] (주체 A), [...] (주체 B)
